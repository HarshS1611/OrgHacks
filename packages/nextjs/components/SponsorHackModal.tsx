      ...
      <div className="relative w-auto my-6 mx-auto">
        <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-[48rem] bg-[#1a1e27] outline-none focus:outline-none ">
          <div className="flex items-start justify-between p-5 border-b border-solid border-gray-300 rounded-t ">
            <h3 className="text-3xl font-semibold text-white">Sponsorship Details</h3>
            <button
          ...
          <div className="relative p-3 flex-auto">
            <form className="bg-transparent shadow-md rounded px-8 pt-3 pb-8 w-full">
              <label className="block text-white text-sm font-semibold mb-1">Task Name*</label>
              <input
                type="text"
              ...
              />
              <label className="block text-white text-sm font-semibold">Task Description*</label>
              <textarea
              ...
              <input
                ...
                max={100}
              />
              <label className="block text-white text-sm font-semibold mb-1">Duration(days)*</label>
              <input
                type="number"
                className="shadow appearance-none border rounded w-full text-white
                                       block h-10 bg-[#ffffff12] text-white rounded-lg px-2 border border-slate-600 py-5 mt-2 mb-2 mr-10 text-sm w-full focus:outline-none
